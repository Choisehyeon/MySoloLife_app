...
import com.example.mysololife.board.BoardLVadapter
...
class TalkFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.boardLV.adapter = boardLVadapter

        binding.boardLV.setOnItemClickListener { parent, view, position, id ->

            //첫번째 방법 -> listview에 있는 데이터 다 전달해서 만들기
            ...
            //두번째 방법  -> 파이어베이스에 있는 board에 대한 데이터의 id를 기반으로 다시 데이터 받아오기
            val intent = Intent(context, BoardInsideActivity::class.java)
